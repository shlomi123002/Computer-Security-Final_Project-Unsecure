...
def create_user(db: Session, user: UserCreate):
    ...
    insert_user_query = f"INSERT INTO users (userName, email, password, salt) VALUES ('{user.username}', '{user.email}', '{hashed_password}', '{salt}')"
...
def check_password_history(db: Session, username: str, new_password: str) -> bool:
    ...
    """
    password_histories = db.execute(password_history_query).fetchall()
